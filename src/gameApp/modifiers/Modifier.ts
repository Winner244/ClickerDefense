...
export class Modifier{
	...
	drawBehindObject(object: AttackedObject, drawsDiffMs: number, isGameOver: boolean, shiftX: number, shiftY: number, sizeScale: number|null = null){}
	drawAheadObject(object: AttackedObject, drawsDiffMs: number, isGameOver: boolean, shiftX: number, shiftY: number){}
	drawAheadObjects(object: AttackedObject, drawsDiffMs: number, isGameOver: boolean, shiftX: number, shiftY: number){}
}