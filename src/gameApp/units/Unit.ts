...
export class Unit extends UpgradableAttackedObject {
	...
	{
		super(x, y, true, isLand, name, shopName, scaleSize, image, frames, animationDurationMs, reduceHover, healthMax, price, isSupportHealing, isSupportUpgrade, imageHandler);
