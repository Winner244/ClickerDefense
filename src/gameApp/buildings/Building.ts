...
export class Building extends UpgradableAttackedObject{
	...
	protected isFixedY: boolean = false; //фиксированная Y позиция (если нет - то будет вызвана функция getY для записи положения y)
	...
	{
		super(x, y, isLeftSide, isLand, name, shopName, scaleSize, image, frames, animationDurationMs, reduceHover, healthMax, price, isSupportRepair, isSupportUpgrade, imageHandler);
	...
	getY(): number{
		return (Draw.canvas ? Draw.canvas.height : 0) - this.height;
	}
