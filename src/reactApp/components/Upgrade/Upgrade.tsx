...
export class Upgrade extends React.Component<Props, {}> {
  ...
  repair(e : React.MouseEvent<HTMLButtonElement, MouseEvent>){
                            ...
                            <div className='upgrade__parameter-buttons-box'>
                              ...
                              {infoItem.label == Building.improveHealthLabel && this.props.selectedBuilding?.health != this.props.selectedBuilding?.healthMax
                                ? <div className='upgrade__parameter-buttons-box-group'>
                                    <span className={'upgrade__parameter-price' + (this.props.selectedBuilding?.isCanBeRepaired() != true ? 'upgrade__parameter-price--red' : '')}>{this.props.selectedBuilding?.getRepairPrice()}
                                      <img className='nodrag upgrade__parameter-price-image' src={CoinImage}/>
                                    </span>

                                    <button className='upgrade__parameter-button upgrade__parameter-button--repair' disabled={this.props.selectedBuilding?.isCanBeRepaired() != true} onClick={(e) => this.repair(e)}>
                                ...
                                {infoItem.improvePoints && infoItem.priceToImprove
                                  ? <div className='upgrade__parameter-buttons-box-group'>
                                      <span className={'upgrade__parameter-price ' + (infoItem.priceToImprove > Gamer.coins ? 'upgrade__parameter-price--red' : '')}>{infoItem.priceToImprove}
                                        <img className='nodrag upgrade__parameter-price-image' src={CoinImage}/>
                                      </span>
